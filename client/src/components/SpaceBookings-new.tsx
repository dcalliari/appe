...
import { Calendar, Clock, MapPin, Plus, Users, Check, X } from 'lucide-react';
...
export const SpaceBookings = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.space_name || !formData.booking_date || !formData.start_time || !formData.end_time) {
      toast({
          ...
          <DialogContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Select value={formData.space_name} onValueChange={(value) => setFormData({ ...formData, space_name: value })}>
                  <SelectTrigger>
