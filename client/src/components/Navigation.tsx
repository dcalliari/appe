    ...
    <>
      <header className="bg-primary text-primary-foreground p-4 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="font-bold text-lg">Apê</h1>
            <p className="text-primary-foreground/80 text-sm">Apt. {user?.apartment}</p>
          </div>
        </div>
          ...
          {navItems.map((item) => {
            ...
            return (
              <Button
                ...
                className={`flex flex-col items-center space-y-1 h-auto py-2 px-3 ${isActive
